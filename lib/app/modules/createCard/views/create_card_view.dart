...
import '../widget/main_three/create_display_section.dart';
import '../widget/main_three/create_field_section.dart';
import '../widget/main_three/create_general_section.dart';

class CreateCardView extends GetView<CreateCardController> {
  const CreateCardView({Key? key}) : super(key: key);
            ...
            actions: [
              Padding(
                ...
                child: GestureDetector(
                    onTap: () {
                      if (!controller.isApiCallInProgress.value) {
                        controller.isApiCallInProgress.value = true;
                        controller.cardCreateRequestModelValues.value =
                          ...
                          /*userCardFields: [
                            UserCardField(
                              fieldId: controller.fieldId.value,
                              input1Text: controller
                                  .socialLinkController.value.text
                                  .toString(),
                              input2Text: controller
                                  .socialUserNameController.value.text
                                  .toString(),
                            ),
                          ],*/
                        );
                        controller
                          ...
                          controller.cardCreateRequestModelValues.value,
                            ...
                            .then((_) {
                          Get.snackbar("", "Card Created Successfully!");
                        }).catchError((error) {
                          Get.snackbar("", "Error When Card Created!");
                        }).whenComplete(() {
                          controller.isApiCallInProgress.value = false;
                        });
                      }
                    },
                    child: Center(
                ...
                child: Column(
                  children: [
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor:
                                controller.selectedColorForAll.value ??
                                    AppColors.purple_1,
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(5.r),
                            ),
                    ...
                    Container(
                      ...
                      child: TabBar(
                        ...
                        indicator: BoxDecoration(
                          ...
                          color: controller.selectedColorForAll.value ??
                              AppColors.purple_1,
                        ),
                      ),
                    ),
                    Expanded(
                      child: TabBarView(
                        children: [
                          CreateGeneralSection(controller),
                          CreateDisplaySection(controller),
                          CreateFieldSection(controller),
                        ],
                      ),
                    ),
                  ],
